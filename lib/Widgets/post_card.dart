  ...
  Future<void> _recordView() async {
    ...
    try {
      ...
      if (existingViews.isNotEmpty) {
        if (mounted) setState(() => _isViewRecorded = true);
        return;
      }
...
📱 Imkon Job ilovasida batafsil ma'lumot
      ''';
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  controller:
                      _scrollController, // ✅ Scroll controller qo'shildi
  ...
  Widget _buildPostTypeBadge() {
    ...
    switch (postType) {
      ...
      case 'one_time_job':
        ...
        break;
      case 'service_offering': // ✅ Yangi tur
